...
const init = async () => {
  ...
  const tables: { title: string, file: string }[] = [
    ...
    { title: "Customizations", file: "customizations.mysql" },
    { title: "Downloads", file: "downloads.mysql" },
    { title: "External Providers", file: "externalProviders.mysql" },
    { title: "External Videos", file: "externalVideos.mysql" },
